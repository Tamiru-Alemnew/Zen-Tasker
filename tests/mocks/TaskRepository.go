...
func (_m *TaskRepository) Delete(ctx context.Context, id int) error {
...
func (_m *TaskRepository) GetByID(ctx context.Context, id int) (*domain.Task, error) {
	ret := _m.Called(ctx, id)
...
func (_m *TaskRepository) Update(ctx context.Context, id int, task *domain.Task) error {
